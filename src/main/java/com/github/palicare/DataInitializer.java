...
public class DataInitializer {
    ...
    public void initData() {
        ...
        PatientDTO patient1 = new PatientDTO(
                ...
                "Deutsch",
                (byte) 3,
                "{\"Vorlieben\":\"Mag Katzen\",\"Abneigungen\":\"Mag keine Hunde\"}",
                100,
        ...
        PatientDTO patient2 = new PatientDTO(
                ...
                "Deutsch",
                (byte) 2,
                "{\"Vorlieben\":\"Hat viele Hunde Zuhause\",\"Abneigungen\":\"Hat Angst vor Nadeln\"}",
                120,
        ...
        PatientDTO patient3 = new PatientDTO(
                ...
                "Deutsch",
                (byte) 4,
                "{\"Vorlieben\":\"Mag Vögel\",\"Abneigungen\":\"Hat Angst vor Hochhäusern\"}",
                110,
